...
Jobs can be started manually from the UI, by a [cron schedule](./automation#cron-schedules), by a [webhook trigger](./automation#webhook-triggers), from a [chatbot](./automation#chatbots), or from a [Plural Flow](../flows/index).
